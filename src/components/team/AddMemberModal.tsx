...
import { TransitionChild, DialogPanel, Dialog, Transition, DialogTitle } from '@headlessui/react';
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-10">
                                    ...
                                    <p className="text-xl mt-5 text-center">Busca el nuevo integrante por email {''}
                                        <span className="text-fuchsia-600 font-semibold">para agregarlo al proyecto</span>
                                    </p>
