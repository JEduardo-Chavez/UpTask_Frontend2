...
import { chechPassword } from '@/api/AuthAPI';
...
export default function DeleteProjectModal() {
    ...
    const checkUserPasswordMutation = useMutation({
        mutationFn: chechPassword,
        onError: (error) => {toast.error(error.message)}
    })


    /** REALIZAR VARIAS MUTACIONES AL MISMO TIMEPO ESCALADAS POR ASYNC */
                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-8">
                                ...
                                <p className="text-xl font-bold">Para eliminar el proyecto {''}
                                    <span className="text-fuchsia-600">coloca tu password</span>
                                </p>
